...
var M = function(t2) {
  function o2(o3) {
    ...
    return (n3 = t2.call(this, o3) || this)._getState = function() {
      ...
      if (n3.dimensionsCache_) {
        var e2 = n3.hoverKey_;
        e2 != null && (n3.props.onChildMouseLeave && n3.props.onChildMouseLeave(e2, n3.hoverChildProps_), n3.hoverKey_ = null, n3.hoverChildProps_ = null, n3.setState({ hoverKey: null }));
      }
        ...
        if (t3) {
          ...
          if (import_react.default.Children.forEach(n3.state.children, function(e2, i2) {
            if (e2 && (e2.props.latLng !== void 0 || e2.props.lat !== void 0 || e2.props.lng !== void 0)) {
              var s3 = e2.key != null ? e2.key : i2, a2 = n3.props.distanceToMouse(n3.dimensionsCache_[s3], t3, e2.props);
  ...
  return n2.componentDidMount = function() {
    ...
    var n3 = import_react.default.Children.map(this.state.children, function(o4, n4) {
      if (o4) {
        ...
        var r2 = o4.props.latLng !== void 0 ? o4.props.latLng : { lat: o4.props.lat, lng: o4.props.lng }, i = t3.props.insideMapPanes ? t3.props.geoService.fromLatLngToDivPixel(r2) : t3.props.geoService.fromLatLngToCenterPixel(r2), s2 = { left: i.x, top: i.y };
...
var z = function(e2, t2) {
  ...
  if (t2 && (o2.length !== 0 && o2.includes("visualization") || o2.push("visualization"), console.warn("heatmapLibrary will be deprecated in the future. Please use { libraries: ['visualization'] } in bootstrapURLKeys property instead")), Object.keys(e2).indexOf("callback") > -1) {
...
function N(e2) {
  return typeof e2 == "number" || function(e3) {
    return !!e3 && typeof e3 == "object";
  }(e2) && I.call(e2) === "[object Number]";
}
var Z = null;
function j() {
  if (Z)
...
var B;
var W = typeof document != "undefined" && document.attachEvent;
var V = false;
if (G && !W) {
  F = function() {
...
var ie;
var se;
var ae = import_react_dom.default.createPortal !== void 0;
...
var he = function(t2) {
  function o2(o3) {
    ...
    if ((r3 = t2.call(this, o3) || this)._getMinZoom = function() {
      ...
      var e2;
      r3.props.onGoogleApiLoaded && (r3.props.yesIWantToUseGoogleMapApiInternals !== true && console.warn("GoogleMap: Usage of internal api objects is dangerous and can cause a lot of issues.\nTo hide this warning add yesIWantToUseGoogleMapApiInternals={true} to <GoogleMap instance"), (e2 = r3.props).onGoogleApiLoaded.apply(e2, arguments));
      ...
      var e2;
      return r3.props.onClick && !r3.childMouseDownArgs_ && new Date().getTime() - r3.childMouseUpTime_ > 300 && r3.dragTime_ === 0 && (e2 = r3.props).onClick.apply(e2, arguments);
  ...
  return r2.componentDidMount = function() {
    ...
    if (_(e2.defaultCenter, this.props.defaultCenter) || console.warn("GoogleMap: defaultCenter prop changed. You can't change default props."), _(e2.defaultZoom, this.props.defaultZoom) || console.warn("GoogleMap: defaultZoom prop changed. You can't change default props."), !this._isCenterDefined(e2.center) && this._isCenterDefined(this.props.center) && setTimeout(function() {
      ...
      if (A(this.props.zoom) || Math.abs(this.props.zoom - e2.zoom) > 0 && this.map_.setZoom(this.props.zoom), !A(e2.draggable) && A(this.props.draggable) ? this.map_.setOptions({ draggable: this.defaultDraggableOption_ }) : _(e2.draggable, this.props.draggable) || this.map_.setOptions({ draggable: this.props.draggable }), !A(this.props.options) && !_(e2.options, this.props.options)) {
        var i = P(this.maps_, H), s2 = typeof this.props.options == "function" ? this.props.options(i) : this.props.options;
